...
static void stm32l1_to_input(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
    stm_pin->reg->MODER &= ~GPIO_MODE_MASK(stm_pin->pin_n);
}
    
static void stm32l1_to_output(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
...
static void stm32l1_set_value(gpioif_t *pin, int v)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
...
static int stm32l1_value(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
...
static bool_t stm32l1_gpio_irq_handler(void *arg)
{
    int handler_idx = (int)arg;
    stm32l1_gpio_hndl_list_item_t *item;
...
static void stm32l1_attach_interrupt(gpioif_t *pin, unsigned event, 
        gpio_handler_t handler, void *arg)
{
    ...
    if (! (handler_state & (1 << handler_idx))) {
        _UC(uos) mutex_attach_irq(&exti_mutex[handler_idx], irq_n[handler_idx], 
            stm32l1_gpio_irq_handler, (void *)handler_idx);
...
static void stm32l1_detach_interrupt(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
...
static int stm32l1_interrupt_pending(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
    return stm_pin->int_pending;
}

static void stm32l1_clear_interrupt(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
    stm_pin->int_pending = 0;
}

static mutex_t *stm32l1_get_mutex(gpioif_t *pin)
{
    stm32l1_gpio_t *stm_pin = (stm32l1_gpio_t *)pin;
        ...
        unsigned flags)
{
    ...
    gpioif->to_input = stm32l1_to_input;
    gpioif->to_output = stm32l1_to_output;
    gpioif->set_value = stm32l1_set_value;
    gpioif->value = stm32l1_value;
    gpioif->attach_interrupt = stm32l1_attach_interrupt;
    gpioif->detach_interrupt = stm32l1_detach_interrupt;
    gpioif->interrupt_pending = stm32l1_interrupt_pending;
    gpioif->clear_interrupt = stm32l1_clear_interrupt;
    gpioif->get_mutex = stm32l1_get_mutex;
